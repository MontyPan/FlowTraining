...
而 MontyPan/FlowTraining 來源是 DontCareAbout/FlowTraining，而不是我的 FlowTraining，所以才無法發 Pull request 給 MontyPan。

假如 MontyPan fork 我的 FlowTraining 後，再更新我的 FlowTraining 就可以發 Pull request 給 MontyPan。
